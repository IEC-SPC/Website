function Message(props: { title: string, message: string }) {
  return (
    <div className='relative flex flex-col gap-4 justify-center bg-bg-img bg-cover bg-center bg-opacity-50 mix-blend-multiply bg-blue px-8 py-4 w-[54rem] min-h-[275px] rounded-[50px]'>
